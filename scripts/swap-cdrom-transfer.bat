...
echo.
echo === changing cdrom to transfer.iso (DirectX7 + AmigaMerlin) ===
docker exec win98_rebuild bash -c "(echo 'change ide1-cd0 /vm/transfer.iso'; sleep 2) | nc -q 3 127.0.0.1 4444"
echo.
echo === confirming ===
